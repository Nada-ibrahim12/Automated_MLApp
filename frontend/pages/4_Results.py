...
if st.button("Save Model"):
    try:
        artifact_bytes, artifact_name = download_model_artifact(
...
if result.get("cluster_descriptions"):
    ...
    for idx, (cluster_id, descriptions) in enumerate(
