...
def select_and_train_model(task_type, X_train, X_test, y_train, y_test, n_clusters, feature_names=None):
    ...
    if task_type == "classification":
        ...
        return clustering_models(X_train, n_clusters, feature_names=feature_names) 
